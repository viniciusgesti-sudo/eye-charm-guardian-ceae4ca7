    ...
    categories: [
      {
        ...
        label: "Technology",
        items: [
          { q: "What does Honest Science™ mean at Eyegis?", a: "Honest Science™ is our commitment to describe what our lenses do optically — not to promise how you will feel wearing them. E-Guard Retina™ and E-Guard Circadian™ use selective filtering: they act only on the specific wavelengths of visible light involved in digital eye strain and evening exposure, and let the rest of the spectrum pass through so colors stay true.", related: ["technology", "lenses"] },
          { q: "How does selective filtering work?", a: "Selective filtering means the lens targets a narrow, specific portion of the visible spectrum — the wavelengths linked to digital eye strain and to evening light exposure — while remaining highly transparent everywhere else. It is not a tint applied over your vision.", related: ["technology", "lenses"] },
          { q: "Do Eyegis lenses change how colors look?", a: "No. Because the filtering is selective and not a broad tint, colors on your screen and around you keep their true appearance — which matters for designers, photographers and anyone working with color.", related: ["lenses"] },
          { q: "Why don't your lenses have an orange or yellow tint?", a: "Heavily tinted lenses filter a wide portion of the spectrum, which distorts whites and colors. E-Guard Retina™ and E-Guard Circadian™ filter selectively instead, so you keep color fidelity without a visible cast.", related: ["technology", "lenses"] },
          { q: "What is different from ordinary blue-light glasses?", a: "Many lenses on the market either filter too little to be meaningful, or filter so broadly that they distort color. Eyegis is engineered around selective filtering and around frames worthy of daily wear — and we describe exactly what the lens does, nothing more.", related: ["technology", "collections"] },
        ],
      },
      {
        id: "products",
    ...
    categories: [
      {
        ...
        label: "Tecnologia",
        items: [
          { q: "O que é a Honest Science™ na Eyegis?", a: "Honest Science™ é nosso compromisso de descrever o que as lentes fazem opticamente — sem prometer como você vai se sentir usando elas. As E-Guard Retina™ e E-Guard Circadian™ usam filtragem seletiva: atuam apenas sobre os comprimentos de onda específicos da luz visível envolvidos na fadiga visual digital e na exposição noturna, deixando o restante do espectro passar para que as cores permaneçam fiéis.", related: ["technology", "lenses"] },
          { q: "Como funciona a filtragem seletiva?", a: "Filtragem seletiva significa que a lente atua sobre uma faixa específica e estreita do espectro visível — os comprimentos de onda associados à fadiga visual digital e à exposição à luz no fim do dia — mantendo alta transparência em todo o restante. Não é um tom aplicado sobre a sua visão.", related: ["technology", "lenses"] },
          { q: "As lentes Eyegis alteram as cores?", a: "Não. Como a filtragem é seletiva e não um tom amplo, as cores da sua tela e ao seu redor permanecem fiéis — essencial para designers, fotógrafos e qualquer profissional que trabalhe com cor.", related: ["lenses"] },
          { q: "Por que suas lentes não têm tom alaranjado ou amarelo?", a: "Lentes muito tingidas filtram uma faixa ampla do espectro, distorcendo brancos e cores. As E-Guard Retina™ e E-Guard Circadian™ filtram de forma seletiva, preservando a fidelidade cromática sem tom visível sobre a imagem.", related: ["technology", "lenses"] },
          { q: "O que difere dos óculos anti-luz azul comuns?", a: "Muitas lentes no mercado filtram tão pouco que não é relevante, ou filtram de forma tão ampla que distorcem as cores. A Eyegis é desenhada em torno da filtragem seletiva e de armações à altura do uso diário — e descrevemos exatamente o que a lente faz, nada além disso.", related: ["technology", "collections"] },
        ],
      },
      {
        id: "products",
    ...
    categories: [
      {
        ...
        label: "Technologie",
        items: [
          { q: "Que signifie Honest Science™ chez Eyegis ?", a: "Honest Science™, c'est notre engagement à décrire ce que font nos verres sur le plan optique — sans promettre ce que vous allez ressentir en les portant. Les E-Guard Retina™ et E-Guard Circadian™ utilisent un filtrage sélectif : ils n'agissent que sur les longueurs d'onde spécifiques de la lumière visible impliquées dans la fatigue visuelle numérique et l'exposition en soirée, et laissent passer le reste du spectre pour que les couleurs restent fidèles.", related: ["technology", "lenses"] },
          { q: "Comment fonctionne le filtrage sélectif ?", a: "Le filtrage sélectif signifie que le verre agit sur une bande spécifique et étroite du spectre visible — les longueurs d'onde associées à la fatigue visuelle numérique et à l'exposition à la lumière en fin de journée — tout en restant très transparent sur le reste. Ce n'est pas une teinte appliquée sur votre vision.", related: ["technology", "lenses"] },
          { q: "Les verres Eyegis modifient-ils les couleurs ?", a: "Non. Comme le filtrage est sélectif et non une teinte large, les couleurs de vos écrans et autour de vous restent fidèles — essentiel pour designers, photographes et tous les métiers de la couleur.", related: ["lenses"] },
          { q: "Pourquoi vos verres n'ont-ils pas de teinte orangée ou jaune ?", a: "Les verres très teintés filtrent une large partie du spectre et déforment les blancs et les couleurs. Les E-Guard Retina™ et E-Guard Circadian™ filtrent de manière sélective : la fidélité des couleurs est préservée, sans teinte visible sur l'image.", related: ["technology", "lenses"] },
          { q: "Quelle différence avec les lunettes anti-lumière bleue classiques ?", a: "Beaucoup de verres sur le marché filtrent soit trop peu pour être significatifs, soit de façon si large qu'ils déforment les couleurs. Eyegis est pensée autour du filtrage sélectif et de montures dignes du quotidien — et nous décrivons exactement ce que fait le verre, rien de plus.", related: ["technology", "collections"] },
        ],
      },
      {
        id: "products",
