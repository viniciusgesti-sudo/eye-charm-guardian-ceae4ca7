...
const COPY = {
  EN: {
    ...
    manifesto: "Eyegis — Digital eye strain eyewear, engineered for vision, designed for style.",
    men: {
      tag: "São Paulo · Night",
      titleA: "Engineered",
      titleB: "for Vision.",
      product: "Men's Collection",
      cta: "Discover the Men's Collection",
    },
    women: {
      ...
      cta: "Discover the Women's Collection",
    },
  },
  PT: {
    eyebrow: "Manifesto Eyegis",
    manifesto: "Eyegis — óculos contra a fadiga visual digital, engenharia para a visão, design para o estilo.",
    men: {
      tag: "São Paulo · Noite",
      titleA: "Engenharia",
      titleB: "para a Visão.",
      product: "Coleção Masculina",
      cta: "Ver a Coleção Masculina",
    },
    women: {
      ...
      cta: "Ver a Coleção Feminina",
    },
  },
  FR: {
    eyebrow: "Manifeste Eyegis",
    manifesto: "Eyegis — lunettes contre la fatigue digitale, engineered for vision, designed for style.",
    men: {
      tag: "São Paulo · Nuit",
      titleA: "L'ingénierie",
      titleB: "de la vision.",
      product: "Collection Homme",
      cta: "Découvrir la Collection Homme",
    },
    women: {
      ...
      cta: "Découvrir la Collection Femme",
    },
  },
} as const;
