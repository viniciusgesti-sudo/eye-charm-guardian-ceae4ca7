...
const COPY: Record<Lang, Copy> = {
  EN: {
    ...
    lead: "Meridian arrives in a fully considered kit — same on every order, whether shipped from Los Angeles, London or São Paulo.",
    items: [
      { title: "Meridian frame",         body: "TR90 lightweight frame with EyegisGuard™ lenses, ready to wear." },
  ...
  PT: {
    ...
    lead: "A Meridian chega com um kit completo — o mesmo em qualquer pedido, seja enviado de Los Angeles, Londres ou São Paulo.",
    items: [
      { title: "Armação Meridian",        body: "Armação TR90 leve com lentes EyegisGuard™, pronta para uso." },
  ...
  FR: {
    ...
    title2: "à sa place.",
    lead: "Meridian arrive dans un kit complet — identique pour chaque commande, expédiée depuis Los Angeles, Londres ou São Paulo.",
    items: [
      { title: "Monture Meridian",        body: "Monture TR90 légère avec verres EyegisGuard™, prête à porter." },
